...
" load close tag
au Filetype html source ~/.vim/scripts/closetag.vim

" Make Vim support Lesscss
...
set path=~/aa/**
" Make SnipMate support .tpl File
au BufRead *.tpl set ft=tpl.html
au BufNewFile *.tpl set ft=tpl.html
